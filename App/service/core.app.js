...
var App = {
    ...
    getAccessToken() {
        return 'd5dbd12e-c3b2-407c-9aec-39159ce38bf5';
    },
    ...
    generateGameUrl: function(gameUrl,params) {
        ...
        targetUrl = 'http://h5.online.vanthink.cn' + '/api2/common_mobile/redirect?access_token=' + this.getAccessToken() + '&game=' + encodeURIComponent(targetUrl);
